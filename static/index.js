...
const getEditForm = function (employee) {
    return `
        ...
        <form id="edit_form_${employee.id}" action="/employees/update?id=${employee.id}"
...
const getCreateForm = function (employee = null) {
    let resultText = `
        ...
        <form id="single_create_form" action="/employees"
                method="post" style="display: none" ">
          <div class="mb-3">
            <label for="first_name" class="form-label">First name</label>
    ...
    if (employee) {
        ...
        <form id="create_form_${employee.id}" action="/employees"
                method="post" style="display: none" ">
          <div class="mb-3">
            <label for="first_name" class="form-label">First name</label>
            <input type="text" id="first_name" name="first_name" value="First name">
...
getJSON('http://localhost:8080/employees/tree',
    function (err, data) {
        if (err !== null) {
            ...
            const toggler = document.getElementsByClassName("rotates_block");
            let i;
            ...
            const btn = document.getElementsByClassName('create_btn');
